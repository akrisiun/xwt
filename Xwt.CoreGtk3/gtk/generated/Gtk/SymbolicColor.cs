...
#region Autogenerated code
	public partial class SymbolicColor : GLib.Opaque {
		...
		[DllImport("libgtk-3-0.dll", CallingConvention = CallingConvention.Cdecl)]
		static extern bool gtk_symbolic_color_resolve(IntPtr raw, IntPtr props, IntPtr resolved_color);

		public bool Resolve(Gtk.StyleProperties props, Gdk.RGBA resolved_color) {
			IntPtr native_resolved_color = GLib.Marshaller.StructureToPtrAlloc (resolved_color);
			bool raw_ret = gtk_symbolic_color_resolve(Handle, props == null ? IntPtr.Zero : props.Handle, native_resolved_color);
			bool ret = raw_ret;
			resolved_color = Gdk.RGBA.New (native_resolved_color);
			Marshal.FreeHGlobal (native_resolved_color);
			return ret;
		}
