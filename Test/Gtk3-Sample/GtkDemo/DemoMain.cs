...
namespace GtkDemo
{
    public class DemoMain
    {
        ...
        public static void Main(string[] args)
        {
            ...
            {
                DemoMain.DemoError = ex;
                Console.WriteLine(ex.Message + Environment.NewLine + ex.StackTrace);
            }
            //Exception thrown: 'System.BadImageFormatException' in cairo3 - sharp.dll
            //Exception thrown: 'System.BadImageFormatException' in glib3 - sharp.dll
        ...
        private void SetupDefaultIcon()
        {
            ...
            try {
                pixbuf = Gdk.Pixbuf.LoadFromResource("gtk-logo-rgb.gif");
            }
            catch (Exception ex)
            {
                // this is not fatal error at all
